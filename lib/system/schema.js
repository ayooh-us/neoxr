module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '© pink venom-md'
      ...
      if (!('owners' in setting)) setting.owners = ['94759874797']
      ...
      if (!('cover' in setting)) setting.cover = 'https://h.top4top.io/p_17461xfk61.png'
      if (!('link' in setting)) setting.link = 'https://whatsapp.com/channel/0029Vaa1t6l5q08V1jdCS33q'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ If you find an error or want to upgrade premium plan contact the owner.',
         style: 4,
         cover: 'https://h.top4top.io/p_17461xfk61.png',
         link: 'https://whatsapp.com/channel/0029Vaa1t6l5q08V1jdCS33q'
      }
   }
}
